...
class ExceptionSetup 
{
    ...
    protected static function handleModelNotFoundException(Exceptions $exceptions)
    {
        $exceptions->render(function (ModelNotFoundException $exception, Request $request) {
            return response()->json(['message' => 'Registro no encontrado', 'errors' => $exception->getMessage()], 404);
        });
    }
    ...
    protected static function handleQueryException(Exceptions $exceptions)
    {
        $exceptions->render(function (QueryException $exception, Request $request) {
            ...
            return response()->json(['message' => 'Error en la base de datos', 'errors' => $exception->getMessage()], 500);
        });
    }
